...
- [flash.yazi](https://github.com/sohanemon/flash.yazi) - A Yazi plugin that enables regex-aware, label-based jumping. Heavily inspired by [flash.nvim](https://github.com/folke/flash.nvim).
