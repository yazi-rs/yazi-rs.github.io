...
2. Go to the `yazi-plugin/preset` folder and find the preset plugin you want to debug, then make changes, such as [logging certain runtime data](/docs/plugins/overview#logging).
