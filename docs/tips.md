...
## Using Yazi as Your Default File Manager/Chooser

The `xdg-desktop-portal-termfilechooser` backend lets you replace the default file picker with a terminal-based one like **Yazi**, providing seamless integration with applications, including Firefox. For installation steps, refer to the [installation guide](https://github.com/boydaihungst/xdg-desktop-portal-termfilechooser?tab=readme-ov-file#installation) and additional instructions available there.
